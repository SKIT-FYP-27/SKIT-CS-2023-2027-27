...
## Go 2 (Week 2) — coming next
Migrations history (`prisma migrate`) + a small service/repository layer
demonstrating real relational queries (e.g. fetch a student with their
enrollments, skills, achievements and risk-radar flags in one call).
